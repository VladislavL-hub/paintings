...
var calc = function calc(size, material, options, promocode, result) {
  var sizeBlcock = document.querySelector(size);
  var materialBlcock = document.querySelector(material);
  var optionsBlcock = document.querySelector(options);
  var promocodeBlcock = document.querySelector(promocode);
  var resultBlcock = document.querySelector(result);
  var sum = 0;

  var calcFunc = function calcFunc() {
    sum = Math.round(+sizeBlcock.value * +materialBlcock.value + +optionsBlcock.value);
